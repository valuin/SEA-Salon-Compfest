...
export default function Header() {
  ...
  return (
    <div className="flex flex-col items-center w-full animate-fadeIn">
      <div className="absolute ml-96 mt-4 px-32 hidden md:block animate-fadeIn">
        <Image
          alt="header"
          src="/headerPic.jpg"
          objectFit="cover"
      ...
      <div className="absolute md:mt-96 md:px-12 md:py-12 md:mr-176 hidden md:block animate-fadeIn">
        <Image
          alt="header"
          src="/header2.jpg"
          objectFit="contain"
