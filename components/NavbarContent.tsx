...
const NavbarContent = () => {
  ...
  return (
    <>
      ...
      {/* Mobile menu */}
      <div
        className={`navbar:hidden fixed top-16 left-0 right-0 bg-primary border-b border-neutral-900/100 transition-opacity duration-300 ${isMenuOpen ? "opacity-100" : "opacity-0 pointer-events-none"}`}
      >
